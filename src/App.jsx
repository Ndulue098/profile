  ...
  return (
    <div className="bg-purple-400/20 min-h-screen flex items-center p-6 ">
      <main className="max-w-3xl sm:h-full w-full mx-auto outline-offset-4 outline-2 outline-gray-800  sm:flex sm:flex-row  flex-col mt-8 rounded-lg overflow-hidden bg-gray-100 text-gray-900">
        {/* Left Section */}
        <div data-testid="test-profile-card" className="sm:w-52 sm:h-auto h-18 bg-purple-400/80 relative border-r border-gray-700 flex sm:flex-col justify-between ">
        ...
        <div className="bg-gray-100 sm:p-6 p-4 sm:rounded-b-none rounded-b-md sm:pt-5 pt-16 sm:rounded-r-md  outline sm:pl-18 flex flex-col border-l  border-gray-700 border">
          <small className="ml-auto rounded-sm mb-4 border border-gray-700 px-1.5 py-0.5 tracking-widest text-xs text-gray-600">
            Time:
            <span data-testid="test-user-time" className="text-[10px] text-purple-700 ml-1">{time} ms</span>
          </small>

          <div className="border-b border-gray-700 pb-2 mb-6 ">
            <h2 data-testid="test-user-name" className="text-3xl font-semibold mb-3 text-gray-900 ">
              Ndulue Christian
            </h2>
            <small data-testid="test-user-bio" className="tracking-[0.25em] uppercase border-b border-gray-700 inline-block mb-2 font-medium text-purple-800">
              Bio
            </small>
          ...
          <div className="flex gap-6">
            <div>
              ...
              <ul data-testid="test-user-hobbies" className="flex gap-3 ml-3 *:text-sm capitalize  text-gray-700">
                <li>Drawing</li>
                <li>Coding</li>
                <li>Tennis</li>
              </ul>
            ...
            <div>
              ...
              <ul data-testid="test-user-dislikes" className="flex gap-3 ml-3 *:text-sm capitalize text-gray-700">
                <li>Biology</li>
                <li>Linear</li>
                <li>Garri</li>
              </ul>
